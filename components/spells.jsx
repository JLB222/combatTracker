...
function Spells(props) {
    return (
        <div className="spells">
            <div>Spell DC: 
                <span style={
                    props.eliteWeakModifier && props.abilityReduction[3] > 0 ? {...props.eliteWeakStyle, ...props.abilityReductionStyle }
            ...
            {props.spells[1]?.length > 0 && props.eliteWeakModifier? <span style={props.eliteWeakStyle}>{props.eliteWeakModifier > 0 ? "Elite: +4" : "Weak: -4"} Damage</span> :null}
            ...
            {props.spells[2]?.length > 0 && props.eliteWeakModifier? <span style={props.eliteWeakStyle}>{props.eliteWeakModifier > 0 ? "Elite: +2" : "Weak: -2"} Damage</span> :null}
